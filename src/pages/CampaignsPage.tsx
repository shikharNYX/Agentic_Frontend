...
const initialCampaigns = [
  {
    ...
    performanceData: [
      { date: '2024-01-01', impressions: 15000, clicks: 3000, costPerConversion: 45 },
      { date: '2024-01-02', impressions: 16000, clicks: 3200, costPerConversion: 43 },
      { date: '2024-01-03', impressions: 17500, clicks: 3500, costPerConversion: 41 },
      { date: '2024-01-04', impressions: 18000, clicks: 3600, costPerConversion: 40 },
      { date: '2024-01-05', impressions: 19000, clicks: 3800, costPerConversion: 38 },
    ],
    isExpanded: false
  },
  {
    ...
    performanceData: [
      { date: '2024-01-01', impressions: 20000, clicks: 4000, costPerConversion: 55 },
      { date: '2024-01-02', impressions: 22000, clicks: 4400, costPerConversion: 53 },
      { date: '2024-01-03', impressions: 24000, clicks: 4800, costPerConversion: 52 },
      { date: '2024-01-04', impressions: 26000, clicks: 5200, costPerConversion: 51 },
      { date: '2024-01-05', impressions: 28000, clicks: 5600, costPerConversion: 50 },
    ],
    isExpanded: false
  },
  {
    ...
    performanceData: [
      { date: '2024-01-01', impressions: 8000, clicks: 1600, costPerConversion: 85 },
      { date: '2024-01-02', impressions: 9000, clicks: 1800, costPerConversion: 83 },
      { date: '2024-01-03', impressions: 10000, clicks: 2000, costPerConversion: 82 },
      { date: '2024-01-04', impressions: 11000, clicks: 2200, costPerConversion: 81 },
      { date: '2024-01-05', impressions: 12000, clicks: 2400, costPerConversion: 80 },
    ],
    isExpanded: false
  }
];
  ...
  1: [
    {
      ...
      details: 'Based on current performance trends, increasing the budget could lead to more conversions while maintaining CPA.'
    },
    {
      id: 'rec2',
      campaignId: 1,
...
const CampaignsPage: React.FC = () => {
  ...
  const handleApplyRecommendation = (recommendation: Recommendation) => {
    ...
    dispatch({ type: 'UPDATE_CAMPAIGN', campaign: { ...campaign, ...changes } });
  };

  const onEditCampaign = (campaignId: number, updates: Partial<CampaignState>) => {
      ...
      <div className="max-w-[1600px] mx-auto space-y-6">
        ...
        <div className="space-y-6">
          <div className="mb-6">
            ...
            <p className="text-purple-300/80 text-sm mt-1">Manage and optimize your active campaigns</p>
          </div>
              ...
              <div className="grid grid-cols-1 gap-6">
                {campaigns.map((campaign) => (
                  <CampaignItem
                    ...
                    onToggleExpand={() => dispatch({ type: 'TOGGLE_EXPAND', id: campaign.id })}
